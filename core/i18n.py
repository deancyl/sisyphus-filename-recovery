...
STRINGS = {
    "en": {
        ...
        "lang_label": "Lang",
        "config_label": "Preset:",
        "preset_none": "(none — built‑in fingerprints only)",
        "preset_standard": "Standard GBK/UTF-8 Recovery",
        "preset_media": "Media & Torrent Recovery",
        "preset_office": "Office & Batch Recovery",
        "preset_custom": "Load custom YAML...",
    ...
    "zh": {
        ...
        "lang_label": "语言",
        "config_label": "预设:",
        "preset_none": "(无预设 — 仅用内置指纹)",
        "preset_standard": "标准 GBK/UTF-8 修复",
        "preset_media": "媒体与种子恢复",
        "preset_office": "办公批量文件恢复",
        "preset_custom": "加载自定义 YAML...",
